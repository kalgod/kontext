...
MANAGER = Step1XEditV1P2Manager()

def warp_modules(pipeline, **args):
    MANAGER.set_parameters(args)
    pipeline.__class__ = RegionEStep1XEditPipelineV1P2
...
def unwarp_modules(pipeline):
    pipeline.__class__ = Step1XEditPipelineV1P2
...
class RegionEStep1XEditPipelineV1P2(Step1XEditPipelineV1P2):
    ...
    def __call__(
        ...
        """
        assert num_inference_steps == MANAGER.inference_step, "num_inference_steps must be equal to 28"
