# ! The current version does not support multiple image references.
import os
import time
import json
import torch
...
if __name__ == "__main__":
    ...
    # config for path
    parser.add_argument("--model_path", type=str, default="/mnt/jfs-test/lib/Qwen-Image-Edit-2509", help="Path to the pre-trained model")
    ...
    if args.use_regione:
        ...
        pipe = QwenImageEditPlusPipeline.from_pretrained(args.model_path, torch_dtype=torch.bfloat16).to(args.device)
