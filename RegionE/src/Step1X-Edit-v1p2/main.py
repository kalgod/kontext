...
from utils import MANAGER, Step1XEditPipelineV1P2, pipeline_call


if __name__ == "__main__":

    parser = argparse.ArgumentParser()
    # config for Step1X-Edit-v1p2
    ...
    # config for path
    parser.add_argument("--model_path", type=str, default="/mnt/jfs-test/lib/Step1X-Edit-v1p2", help="Path to the pre-trained model")
    ...
    parser.add_argument("--output_dir", type=str, default="result/Step1X-Edit-v1p2/Demo/RegionE", help="Directory to save the output images")
    ...
    if args.use_regione:
        ...
        Step1XEditPipelineV1P2.__call__ = pipeline_call     # fix the resolution
        pipe = Step1XEditPipelineV1P2.from_pretrained(args.model_path, torch_dtype=torch.bfloat16).to(args.device)
